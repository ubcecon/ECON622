...
20. **November 20** [Dynamic discrete choice](https://github.com/UBCECON567/DynamicDiscreteChoice.jl), Nested fixed-point, Heterogeneity and finite mixtures (EM)
...
24. **December 4** Networks II - Endogenous networks, Homophily, Embeddings, Graph Neural Networks (time permitting)
