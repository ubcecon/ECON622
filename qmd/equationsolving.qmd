...
function G(δ,p)
    d=log.(p.s) - log.(share([0,δ...], p.Σ, p.dFν, p.x, p.∫))
    return(d[2:end])
end
...
- [NonlinearSolve.jl's recommended methods](https://docs.sciml.ai/NonlinearSolve/stable/solvers/nonlinear_system_solvers/#Recommended-Methods) are usually a good choice
